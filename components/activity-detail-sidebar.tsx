...
export function ActivityDetailSidebar({
  activity,
  onClose,
  ...
  const handleAddTask = (
    newTask: Omit<(typeof tasks)[0], "id" | "completed">
  ) => {
    const nextTaskId =
      tasks.length > 0 ? Math.max(...tasks.map((t) => t.id)) + 1 : 1;
    setTasks((prevTasks) => [
      ...prevTasks,
      { id: nextTaskId, completed: false, ...newTask },
    ]);
  };
  ...
  const handleAddStakeholder = (newStakeholder: {
    name: string;
    role: string;
    image: string;
  }) => {
                    ...
                    >
                      ...
                      <DialogContent className="sm:max-w-[425px]">
                        ...
                        <AddStakeholderForm
                          ...
                          stakeholders={dummyStakeholders}
                          onOpenChange={setStakeholderDialogOpen}
                        />
                      </DialogContent>
                    </Dialog>
                    ...
                    <div className="mb-4 space-y-2">
                      ...
                      <div className="text-sm text-muted-foreground">
                        {(() => {
                          ...
                          if (progress < 100)
                            return "So close to the finish line! 🏃‍♂️";
                          ...
                          <div className="flex items-start gap-3">
                            <Checkbox
                              ...
                              className={cn(
                                ...
                                task.completed &&
                                  "border-green-500 bg-green-500/10 data-[state=checked]:bg-green-500 data-[state=checked]:text-white"
                              )}
                            />
                              ...
                              <div className="flex items-start justify-between gap-2">
                                ...
                                <DropdownMenu>
                                  ...
                                  <DropdownMenuContent align="end">
                                    ...
                                    <DropdownMenuItem
                                      onSelect={() => handleTaskDelete(task.id)}
                                    >
                                      Delete
                                    </DropdownMenuItem>
                                  </DropdownMenuContent>
...
const AddStakeholderForm: React.FC<AddStakeholderFormProps> = ({
  ...
  return (
    <form onSubmit={handleSubmit} className="grid gap-4 py-4">
      ...
      <DialogFooter>
        <Button type="submit" disabled={!selectedStakeholder}>
          Add Stakeholder
        </Button>
      </DialogFooter>
    </form>
