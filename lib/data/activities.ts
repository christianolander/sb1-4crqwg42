...
export const activities: ActivityDetail[] = [
  {
    ...
    progress: 25,
    description:
      "New employee onboarding process for Karl Karlsson, starting April 1st, 2024",
    stakeholders: [
      {
        name: "John Davis",
        role: "HR Manager",
    ...
    tasks: [
      {
        ...
        content:
          "Hi there! We are stoked that you are joing our team. On your first day, we will have a lot of fun stuff planned for you. ",
      ...
      },
      {
        id: 4,
        title: "Send automated email",
        subject: "New employee onboarding updates",
        completed: false,
        assignee: "System",
        type: "email",
